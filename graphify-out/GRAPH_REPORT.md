...
9. `2. Use Case Catalog` - 12 edges
10. `formDataToObject()` - 11 edges
...
Cohesion: 0.29
Nodes (6): 10. Key Design Decisions & Trade-offs, 1.1 High-Level Architecture, 1.2 Architectural Philosophy, 1. System Context & Architecture, BMC — Design Document [UPDATED 2026-06-23], Table of Contents

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (38): 10. Verification Checklist, 1. TDD as Compulsory Practice, 2.1 Unit Tests — Pure Functions (Vitest), 2.2 Component Tests (Vitest + Testing Library), 2.3 Server Action Tests (Vitest), 2.4 API Route & SSE Tests (Supertest + Dev Server), 2.5 E2E Tests (Playwright), 2.6 SDUI Service & Schema Tests (Vitest) (+30 more)
...
Cohesion: 0.11
Nodes (18): 0. TDD is compulsory — never write code without a failing test first, 10. Key commands, 1. Always consult DESIGN.md before making architecture decisions, 2. Always consult USECASE.md before adding features, 3. Server-first rendering, 4. Streaming, not polling, 5. No global state library, 6. Validate on every mutation (+10 more)
...
Cohesion: 0.06
Nodes (32): 1.1 Human Actors, 1.2 System Actors, 1. Actors, 2.10 Cross-Cutting, 2.11 Smart Dynamic Dashboard (SDUI), 2.1 HVAC Control, 2.2 Lighting Control, 2.3 Security & Access Control (+24 more)

### Community 14 - "Community 14"
Cohesion: 0.25
Nodes (5): inter, metadata, mockUsePathname, Navigation(), navLinks
